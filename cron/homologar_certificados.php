...
include_once $caminhoApp . '/classes/matriculas_novo.class.php';
...
$sql = "SELECT 
        ...
        WHERE 
        ma.idmatricula in (5348,5850) and
...
while ($linha = mysql_fetch_assoc($query)) {
    ...
    echo "<br>idmatricula -> ".$linha['idmatricula'];
    echo "<br>documentosObrigatoriosPendentes -> ";
    var_dump($documentosObrigatoriosPendentes);
    echo "<br>";
    die();
