...
$valorResultado = "CursoDistanciaAtualizarResult";
...
while ($dados = mysql_fetch_assoc($query)) {
    ...
    $arrayEnvio = [
        ...
        'FimModulo' => $arrData[$dados['idmatricula']]['dt_fim'],
    ];
    $_POST = json_encode($arrayEnvio);
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $config['detran']['PE']['urlJSON'] . '/CursoDistanciaAtualizar');
    ...
    $transacoes->iniciaTransacao(INTERFACE_DETRAN_PE_CREDITOS, 'E');
    ...
    salvarLogDetran($matriculaObj, 424, $dados['idmatricula'], $mensagem, $_POST);
