...
if (isset($url[3])) {
    if ('novamatricula' == $url[3]) {
        if ($usuario['criar_modificar_matricula'] == 'S') {
    ...
    $matriculaObj->Set('campos', 'm.*, cw.nome as situacao, cw.cor_bg as situacao_cor_bg, cw.cor_nome as situacao_cor_nome, p.nome as aluno, p.documento, p.email, o.nome as oferta, ot.nome as turma, v.nome as vendedor ');
