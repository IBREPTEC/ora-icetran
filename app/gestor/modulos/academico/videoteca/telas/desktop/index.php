...
<body onmousedown="isKeyPressed(event)">
  ...
  <div class="container-fluid">
    ...
    <ul class="breadcrumb">
        ...
        <?php if($_GET["q"] || $_GET['termo'] || $_GET['tag']) { ?><li><span class="divider">/</span> <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>"><?= $idioma["nav_resetarbusca"]; ?></a></li><?php } ?>
...
<?php
    ...
    foreach ($dadosArray as $dados) {
        ...
        if ('youtube' == $dados['variavel'] || 'vimeo' == $dados['variavel']) {
            $html .= '<iframe src="'.$dados['arquivo'].'" border="0" width="420" height="345" style="border: medium none"></iframe>';
        }
