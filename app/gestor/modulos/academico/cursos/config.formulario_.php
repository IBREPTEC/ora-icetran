    ...
    array(
        ...
        "campos" => array(
            ...
            array(
                ...
                "botao_hide" => true,
                "iddiv" => "codigo_diploma_obrigatorio",
                "iddiv_obr" => true,
                "banco" => true,
                "banco_string" => true
            ),
            array(
                "id" => "form_codigo_diploma_obrigatorio",
                "nome" => "codigo_diploma_obrigatorio",
                "nomeidioma" => "form_codigo_diploma_obrigatorio",
                "tipo" => "select",
                "array" => "sim_nao", // Array que alimenta o select
                "class" => "span2",
                "valor" => "codigo_diploma_obrigatorio",
                "validacao" => array("required" => "codigo_diploma_obrigatorio_vazio"),
                "ajudaidioma" => "form_codigo_diploma_obrigatorio_ajuda",
                "banco" => true,
                "banco_string" => true,
                "select_hidden" => true,
            ),
