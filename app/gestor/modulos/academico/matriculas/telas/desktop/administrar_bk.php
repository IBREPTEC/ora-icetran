...
<div class="container-fluid">
                ...
                <div class=" pull-right">
                    <?php
                      if (count($matriculaObj->retornarToTalTentativasProva()) && ! empty($matricula['situacao']['visualizacoes'][49]) && $matriculaObj->verificaPermissao($perfil["permissoes"], $url[2]."|32", false)) {
                        ?>
                        <!-- <button onclick="zerarValores('<?= $idioma['zerar_tentativas_prova']?>', 'prova');" class="btn btn-small">
                            <?= $idioma["zerar_tentativas_prova"]; ?> (<?= count($matriculaObj->retornarToTalTentativasProva()) ;?>)
                        </button> -->
                                ...
                                if (! empty($matricula['escola']['detran_codigo'])) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         && ($matricula['detran_situacao'] == 'NL') && (
                                                 $matricula['escola']['idestado'] == 17 // PERNAMBUCO
                                                 || $matricula['escola']['idestado'] == 26 // SERGIPE
                                                 || $matricula['escola']['idestado'] == 21 //Rio Grande do Sul
                                                 || $matricula['escola']['idestado'] == 16 //  Paraná
                                                 || $matricula['escola']['idestado'] == 19 // Rio de Janeiro
                                                 || $matricula['escola']['idestado'] == 10 // Maranhão
                                                 || $matricula['escola']['idestado'] == 8 // Espírito Santo
                                                 || $matricula['escola']['idestado'] == 12 // Mato Grosso do Sul
                                                 || $matricula['escola']['idestado'] == 11 // Mato Grosso
                                                 || $matricula['escola']['idestado'] == 2 // Alagoas
                                            ) ){
                                                ?>
                                                <div style="text-align:right; float:right;">
                            ...
                            <form method="post" action="" onsubmit="return validateFields(this, regras_dados_matricula)" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-right:20px;"><input <?php if(!$matricula["situacao"]["visualizacoes"][2] || !$matriculaObj->verificaPermissao($perfil["permissoes"], $url[2]."|6",false)) { ?> disabled="disabled" <?php } ?> id="form_data_matricula" class="inputData" type="text" value="<?= formataData($matricula["data_matricula"], "br", 0); ?>" name="data_matricula"></td>
                                        ...
                                        <td style="padding-left:20px;"><input id="form_data_conclusao" class="inputData" type="text" value="<?= formataData($matricula["data_conclusao"], "br", 0); ?>" name="data_conclusao" <?php if(!$matricula["situacao"]["visualizacoes"][2] || !$matriculaObj->verificaPermissao($perfil["permissoes"], $url[2]."|6",false)) { ?> disabled="disabled" <?php } ?>></td>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td style="padding-right:20px;"><textarea id="observacao" class="span6 " name="observacao" <?php if(!$matricula["situacao"]["visualizacoes"][2] || !$matriculaObj->verificaPermissao($perfil["permissoes"], $url[2]."|6",false)) { ?>disabled="disabled"<?php } ?>><?= $matricula["observacao"]; ?></textarea></td>
                                    </tr>
                                </table> -->
                                <br />
                                <table>
                                    <tr>
                                        <td style="padding-right:20px;"><strong><?= $idioma['dados_matricula_codigo_diploma']; ?></strong></td>
                                    </tr>
                                    <tr>
                                        <td style="padding-right:20px;">
                                            <input <?php if(!$matricula["situacao"]["visualizacoes"][2] || !$matriculaObj->verificaPermissao($perfil["permissoes"], $url[2]."|6",false)) { ?> disabled="disabled" <?php } ?> id="form_codigo_diploma" class="span3 " type="text" value="<?= $matricula['pessoa']['ato_punitivo'] ?>" name="codigo_diploma" maxlength="30">
                                        </td>
                                    </tr>
                                </table>
                                <?php
                                if (in_array($matricula['escola']['idestado'], $numeroDetranPorestado['pt_br'])) {
                                    ?>
                                <br />
                                <table>
                                    <tr>
                                        <td style="padding-right:20px;"><strong><?= $idioma['dados_matricula_numero_detran']; ?></strong></td>
                                    </tr>
                                    <tr>
                                        <td style="padding-right:20px;">
                                            <input <?php if(!$matricula["situacao"]["visualizacoes"][2] || !$matriculaObj->verificaPermissao($perfil["permissoes"], $url[2]."|6",false)) { ?> disabled="disabled" <?php } ?> id="form_detran_numero" class="span3 " type="text" value="<?= $matricula["detran_numero"]; ?>" name="detran_numero" maxlength="30">
                                        </td>
                                    </tr>
                                </table>
                                <?php } ?>
                        ...
                        <section id="dadosaluno">
                            ...
                            <table border="0" cellspacing="0" cellpadding="5" class="table table-bordered table-condensed">
                                <tr>
                                    ...
                                    <td style="border-top:0px"><strong><?= $matricula["pessoa"]["nome"]; ?></strong></td>
                                ...
                                <tr>
                                    ...
                                    <td ><strong><?= $matricula["pessoa"]["celular"]; ?></strong>
                                ...
                                <tr>
                                    ...
                                    <td><strong><?= $matricula["pessoa"]["complemento"]; ?></strong></td>
                                </tr>
                                <tr>
                                    <td><?=$idioma["dados_aluno_bairro"];?></td>
                                    <td><strong><?= $matricula["pessoa"]["bairro"]; ?></strong></td>
                                    <td><?=$idioma["dados_aluno_cidade"];?></td>
                                    <td><strong><?= $matricula["pessoa"]["cidade"];?></strong></td>
                                </tr>
                                <tr>
                                    <td><?=$idioma["dados_aluno_cep"];?></td>
                                    <td><strong><?= $matricula["pessoa"]["cep"]; ?></strong></td>
                                    <td><?=$idioma["dados_aluno_estado"];?></td>
                                    <td><strong><?= $matricula["pessoa"]["estado"];?></strong></td>
                                </tr>
                                <tr>
                                    <td><?=$idioma["dados_aluno_ultimo_acesso"];?></td>
                                    <td colspan="3"><strong><?= ($matricula["pessoa"]["ultimo_acesso"]) ? formataData($matricula["pessoa"]["ultimo_acesso"], 'pt', 1) : ''; ?></strong></td>
                                </tr>
                            </table>
                            <?php
    ...
    <script type="text/javascript">
        ...
        if ($matricula['escola']['idestado'] == 21) { ?>
            regras_dados_matricula.push('length>10,form_detran_numero,Campo deve ter exatamente 11 carácteres');
            regras_dados_matricula.push('length<12,form_detran_numero,Campo deve ter exatamente 11 carácteres');
        <?php
        } ?>
