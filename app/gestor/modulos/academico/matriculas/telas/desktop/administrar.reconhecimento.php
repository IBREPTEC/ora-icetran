                    ...
                    <div class="span12">
                        ...
                        <section>
                            ...
                            <div id="historico_reserva_ancora_div"><?php foreach ($todasComparacoes as $key => $value) {
                                $imagemPri = !empty($value['principal'])
                                    ? $config['urlSistema'] . '/api/get/imagens/matriculas_reconhecimentos/x/x/' . $value['principal']
                                    : $config['urlSistema'] . '/assets/aluno/img/LGPDBIOMETRIAICETRAN.jpg';
                                $imagemCom = !empty($value['foto_comparada_azure'])
                                    ? $config['urlSistema'] . '/api/get/imagens/matriculas_comparacoes_fotos/x/x/' . $value['foto_comparada_azure']
                                    : $config['urlSistema'] . '/assets/aluno/img/LGPDBIOMETRIAICETRAN.jpg';
