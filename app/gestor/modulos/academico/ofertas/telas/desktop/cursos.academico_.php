                        ...
                        <section>
                            ...
                            <form name="formFolhasRegistro" method="post" action="" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td style="padding-right:20px;">
                                            <select class="span4 inputGrande" name="idfolha" id="folhaRegistro">
                                                <option value=""></option>
                                        ...
                                        <td>
                                            <input maxlength="2" value="<?= $linha["porcentagem_minima_disciplinas"] ?>" class="span1 inputGrande" type="text" name="porcentagem_minima_disciplinas" /> %
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                                        <td>
                                            <input maxlength="2" value="<?= $linha["gerar_quantidade_dias"] ?>" class="span1 inputGrande" type="text" name="gerar_quantidade_dias" /> dias
                                        </td>
                                    </tr>
                                </table>
                                <br />
