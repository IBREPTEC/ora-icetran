...
<div class="container-fluid">
    <section id="global">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>"><?= $idioma["pagina_titulo"]; ?></a> <span
                    class="divider">/</span></li>
            <?php if ($url[4] == "editar") { ?>
                <li class="active"><?php echo $linhaCat["nome"]; ?></li>
            <?php } else { ?>
                <li class="active"><?php echo $linhaCat["nome"]; ?></li>
            <?php } ?>
    ...
    <div class="row-fluid">
        <div class="span12"><?php //print_r2($linhaCat);exit; ?>
            <div class="box-conteudo">
                <div class="pull-right"><a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>" class="btn btn-small"><i class="icon-share-alt"></i> <?= $idioma["btn_sair"]; ?></a></div>
          <?php if($url[3] != "cadastrarsubcategoria") { ?><h2 class="tituloEdicao"><?php echo $linhaCat["nome"]; ?></h2><?php } ?>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_editar">
                ...
                <form method="post" onsubmit="return validateFields(this, regras)" enctype="multipart/form-data"
                    ...
                    <?php if ($url[4] == "editarsubcategoria") {
