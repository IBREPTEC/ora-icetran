        ...
        <div class="box-conteudo">
        		...
        		<div id="listagem_informacoes"> 		  
                    ...
                    <span class="pull-right" style="padding-top:3px; color:#999">
						<a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/cadastrar" style="color:#FFF;" class="btn btn-primary"><i class="icon-plus icon-white"></i> <?= $idioma["btn_novoatendimento"]; ?> </a>
                    </span>
                </div>
...
jQuery(document).ready(function($) {
  ...
  $("input[name='q[3|oc.data_cad]']").datepicker($.datepicker.regional["pt-BR"]);
  $("input[name='q[4|oc.valor]']").maskMoney({symbol: "R$", decimal: ",", thousands: "."});
