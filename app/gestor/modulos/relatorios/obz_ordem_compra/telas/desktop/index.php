	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function($) {
            ...
            $('#idcentro_custo').change(function(){
                    if($(this).val()){
                            $.getJSON('/gestor/relatorios/obz_ordem_compra/ajax_categorias/',{idcentro_custo: $(this).val(),
                                                                                              idsindicato: $('#idsindicato').val(),
                                                                                              ajax: 'true'}, function(json){
                                    var options = '<option value="">–  –</option>';
                                    for (var i = 0; i < json.length; i++) {
                                            var selected = '';
                                            if(json[i].idcategoria == 0)
                                            var selected = 'selected';
            ...
            $('#idcategoria').change(function(){
                    if($(this).val()){
                            $.getJSON('/gestor/relatorios/obz_ordem_compra/ajax_subcategorias/',{idcategoria: $(this).val(),
                            ...
                            $('#idsubcategoria').html('<option value="">–  –</option>');
                    }
            });
