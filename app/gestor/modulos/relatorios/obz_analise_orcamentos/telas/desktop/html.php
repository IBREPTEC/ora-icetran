...
<body>
            ...
            <td  align="right" valign="top">
                <table border="0" align="right" cellpadding="3" cellspacing="0" class="impressao">
                    <tr>
                        ...
                        <td>
                            <form method="post" action="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/pdf/enviar_email?<?= $_SERVER["QUERY_STRING"]; ?>">
                                <input class="btn" type="submit" value="<?= $idioma['enviar_email'] ?>" />
                            </form>
                        </td>
                    </tr>
                </table>
    ...
    if (count($dadosArray['erros']) > 0) {
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="10">
            <tr>
                <td><?php printf($idioma["informacoes"], $relatorioObj->Get('total')); ?></td>
            </tr>
        </table>
                    ...
                    <tr>
                        ...
                        foreach ($colunas as $indCol => $coluna) {
                            if ($coluna == 'ano_anterior_realizado' || $coluna == 'ano_atual_orcado') {
                                ...
                                ?>
                                <td>
                                    <a target="_blank" href="/<?= $url[0]; ?>/obz/orcado_realizado?idsindicato=<?= $linha['idsindicato']?>&idcentro_custo=<?= $linha['idcentro_custo']; ?>&ano=<?= $ano; ?>&idcategoria=<?= $linha['idcategoria']; ?>&idsubcategoria=<?= $linha['idsubcategoria']; ?>" <?= $style; ?> >
