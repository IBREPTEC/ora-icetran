...
if($_SESSION['adm_gestor_cfc'] != 'S' && $_SESSION["adm_idperfil"] == 26) {
	$sqlEscola .= ' and idescola in ('.$_SESSION['adm_cfcs'].')';
}
...
$config['listagem'] = array(
	...
	array(
		'id' => 'tabela_razao',
		'variavel_lang' => 'tabela_razao',
		'tipo' => 'banco',
		'valor' => 'razao_social'
	),
	array(
		'id' => 'tabela_cnpj',
		'variavel_lang' => 'tabela_cnpj',
		'tipo' => 'php',
		'valor' => 'return formatar($linha["documento"]);',
	),
	array(
		'id' => 'tabela_email',
