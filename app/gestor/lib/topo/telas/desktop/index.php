            ...
            <div class="container-fluid">
                ...
                <div class="nav-collapse collapse">
                    <ul class="nav" id="menu-topbar" style="display:none;">
                        ...
                        <? } ?>
						<? if ($_SESSION["modulosPermissoes"]["obz"]["acesso"] && $config["modulo_obz"]) { ?>
                            <li><a href="/<?= $url[0]; ?>/obz"><?= $idioma["obz"]; ?></a></li>
                        <? } ?>
            ...
            <div id="divMenu">
                <ul id="menu">
                    ...
                    <? } ?>
					 ...
					 <?php if ($_SESSION["modulosPermissoes"]["obz"]["acesso"] && $config["modulo_obz"]) { ?>
                        <li>
                            <a href="/<?= $url[0]; ?>/obz" class="drop">
                                <div class="divImagem"><img src="/assets/icones/branco/24/tabela_precos_24.png"/></div>
                                <div class="divImagemHover"><img src="/assets/icones/preto/24/tablea_preco_24.png"/>
                                </div>
                                <?= $idioma["obz"]; ?>
                            </a>
                            <div class="dropdown_2columns">
                                <div class="col_2">
                                    <ul class="linkIcone">
                                        <li><a href="/<?= $url[0]; ?>/obz/orcamentos_gastos"
                                               style="background-image:url(/assets/icones/preto/32/menu_completo_32.png)">
                                                <strong><?= $idioma["orcamentos_gastos"]; ?></strong>
                                                <span><?= $idioma["orcamentos_gastos_descricao"]; ?></span></a></li>
                                        <li><a href="/<?= $url[0]; ?>/obz/orcado_realizado"
                                               style="background-image:url(/assets/icones/preto/32/menu_completo_32.png)">
                                                <strong><?= $idioma["orcado_realizado"]; ?></strong>
                                                <span><?= $idioma["orcado_realizado_descricao"]; ?></span></a></li>
                                        <li><a href="/<?= $url[0]; ?>/obz/ordem_compra"
                                               style="background-image:url(/assets/icones/preto/32/menu_completo_32.png)">
                                                <strong><?= $idioma["ordem_compra"]; ?></strong>
                                                <span><?= $idioma["ordem_compra_descricao"]; ?></span></a></li>
                                        <li><a href="/<?= $url[0]; ?>/obz"
                                               style="background-image:url(/assets/icones/preto/32/menu_completo_32.png)">
                                                <strong><?= $idioma["menu_completo"]; ?></strong>
                                                <span><?= $idioma["menu_completo_descricao"]; ?></span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
