...
<link href="/assets/css/logingestor.desktop.css" rel="stylesheet" />
...
<div class='container' id='login'>
  ...
  <div class='row'>
    <div class='span6 offset3'>
      <div class='section section-large formulario' id='login-section'>
        <div class='section-header formularioh' large='large'>
        ...
        <? } ?>
          <form method="post">            
            <input class="span5" name="txt_usuario" type="text" id="txt_usuario" value="<?= $_POST["txt_usuario"]; ?>" size="30" placeholder="Seu Email">
            <br><br>
            <input class="span5" name="txt_senha" type="password" id="txt_senha" size="30" placeholder="Sua Senha"><br><br>
...
<div class="faixa">
    <ul>
      ...
      <li class="linha">Painel do Gestor - v<?php echo $config["oraculo_versao"]; ?></li>
    </ul>
  </div>
</footer>
</body>
