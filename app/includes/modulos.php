...
// OBZ
$config['modulos']['url']['obz'] = array();
$config['modulos']['workflow']['obz_ordem'] = true;
$config['modulos']['url']['obz']['usuariosadm_obz'] = true;
$config['modulos']['url']['obz']['instituicoes_obz'] = true;
$config['modulos']['url']['obz']['unidadesrateio'] = true;
$config['modulos']['url']['obz']['motivos_ordemcompra'] = true;
$config['modulos']['url']['obz']['ordem_compra'] = true;
$config['modulos']['url']['obz']['centrosdecustos_obz'] = true;
$config['modulos']['url']['obz']['subcategorias_obz'] = true;
$config['modulos']['url']['obz']['classificacaodespesas'] = true;
$config['modulos']['url']['obz']['orcamentos_gastos'] = true;
$config['modulos']['url']['obz']['orcado_realizado'] = true;
$config['modulos']['url']['relatorios']['obz_analise_orcamentos'] = true;
$config['modulos']['url']['relatorios']['obz_orcado_realizado'] = true;
$config['modulos']['url']['relatorios']['obz_ordem_compra'] = true;