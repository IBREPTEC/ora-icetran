...
class Historicos extends Core
{
    ...
    public function gerarCertificado($idmatricula, Matriculas $matriculas, $idFolhaRegistro = NULL)
    {
        ...
        $fixed = array(
            ...
            '[[extra][data_expedicao_matricula]]' => FiltrosHelper::transcreverData($information["matricula"]["data_expedicao"]),
            '[[extra][data_da_matricula]]' => FiltrosHelper::converterData($information["matricula"]["data_matricula"], "d/m/Y"),
