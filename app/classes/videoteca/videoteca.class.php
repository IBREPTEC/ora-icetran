...
class Videoteca
{
   ...
   const CURRENT_TABLE = 'videotecas';
	...
	public function retornarAvaVideo($id = null)
    {
        $queryString = 'SELECT %s FROM avas_videotecas avi inner join videotecas v on(avi.idvideoteca=v.idvideo) WHERE avi.ativo="S" and avi.idvideo=%d';
	...
	function CadastrarVideo()
    {
        ...
        return $this->_coreClass->SalvarDados();
    }
