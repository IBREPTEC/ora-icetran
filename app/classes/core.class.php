...
class Core
{
	...
	public function retornarEscapeStringQuery($texto)
    {
        $texto = mb_ereg_replace('[\x00\x1A\x22\x27\x5C]', '\\\0', $texto);
        $texto = mb_ereg_replace('[\x0A]', '\\n', $texto);
        $texto = mb_ereg_replace('[\x0D]', '\\r', $texto);
        return $texto;
    }
...
//Gera o formulario de cadastro(modificar) das CRUD's
    ...
    */
    ...
    function enviarEmail($nomeDe, $emailDe, $assunto, $mensagem, $nomePara, $emailPara, $layout = "layout", $charset = 'iso-8859-1') {
		...
		//if ($_SESSION['adm_idusuario'] == 136 || $_SESSION['adm_idusuario'] == 139) {
		//echo "<pre>";
		//var_dump($nomeDe, $emailDe, $assunto, $mensagem, $nomePara, $emailPara, $layout, $charset);
		//exit;
		//}
