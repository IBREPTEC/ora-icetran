...
class Reconhecimento extends Core {
    ...
    const URL_DETECT = 'https://oraculo-icetran-face.cognitiveservices.azure.com/face/v1.0/detect';
    private $probabDefault;
    private $rangeMinimo;
    private $headers = array('Content-Type' => 'application/json','Ocp-Apim-Subscription-Key' => '15576487553444c4bd7c8d442c27bcc6');
    ...
    public function azure($nome_servidor, $dadosMat){
        ...
        if ($dadosMat['biometria_liberada'] != 'S') {
            ...
            if ($hashFotoPadrao && $hashFotoComparacao) {
                $parameters = array();
                $request = new Http_Request2('https://oraculo-icetran-face.cognitiveservices.azure.com/face/v1.0/verify');
