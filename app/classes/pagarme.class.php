        ...
        if (! empty($erros)) {
        	...
        	try {
				...
				$escola = $escolabj->set('modulo',  $this->url[0])
					...
					->set('campos', 'e.idescola, e.idestado, e.idcidade, e.idsindicato, e.nome_fantasia AS escola, e.documento, e.email, e.documento_tipo,
						CONCAT_WS(" ", l.nome, e.endereco) AS endereco, e.numero, e.complemento,
						e.bairro, c.nome AS cidade, e.cep, e.telefone')
					->retornar();
