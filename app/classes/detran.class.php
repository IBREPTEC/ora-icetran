...
class Detran extends Core
{
	...
	public function retornarLog($idmatricula){
        $sql = "SELECT * FROM detran_logs where idmatricula=$idmatricula order by data_cad desc limit 1 ";
    ...
    public function CertificadoSC($dados)
    {
		...
		if ($this->detran_tipo_aula['SC'][$dados['idcurso']] == 30) {
			$endpoint = '/educacao/ead/grava-curso-atualizacao';
		}
