...
class GestaoAcessos extends Core
{
    ...
    public function contabilizarAcessoMatricula($idPessoa, $idMatricula, $idAva, $idCurso)
    {
        ...
        if ($acessos){
            ...
            if($acessoDiarioTotal <= '08:00:00'){
                ...
                if ($ultimoAcessoTotal > '04:00:00' && $pausaIntervalo < $horasPausaObrigatoria){
                    $retorno['erro'] = array("acesso_bloqueado_4h.png", "Você já atingiu a carga-máxima de 4h/a de estudo ininterruptas, e precisa aguardar o intervalo mínimo de uma hora para retomar o estudo on-line, conforme determina a Resolução 802/2020 e CONTRAN 928/2022.
            ...
            } else $retorno['erro'] = array("acesso_bloqueado_8h.png", "Você já atingiu a carga-máxima de 8h/a diárias, conforme determina a Resolução 802/2020 e CONTRAN 928/2022.<br><br>
