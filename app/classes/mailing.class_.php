...
function listarFilaAddMailingProfessores() {
  ...
  function listarFilaAddMailingVendedores() {
    ...
    public function listarFilaAddMailingVisitaVendedores()
    {
        ...
        $this->sql .= " GROUP BY visitas_vendedores.idvisita ";
        $this->limite = -1;
        $this->ordem_campo = "nome";
        $this->ordem = "ASC";
    ...
    public function listarFilaAddMailingCFC()
    {
        ...
        $this->sql = "SELECT idescola, nome_fantasia, email
            FROM escolas
            WHERE
                NOT EXISTS(
                    SELECT
    ...
    public function listarFilaAddMailingSindicato()
    {
        ...
        $this->sql = "SELECT concat('(',idsindicato,') ',nome_abreviado) as nome, email, idsindicato
            FROM sindicatos
            WHERE
                NOT EXISTS(
                    SELECT
  ...
  function salvarFila() {
    ...
    if($this->url[6] == "usuariosadm") {
      ...
      $tipo = "MA";
    } elseif($this->url[6] == "vendedores") {
      $primaria = "idvendedor";
      $tipo = "VE";
    } elseif($this->url[6] == "visita_vendedores") {
      $primaria = "idvisita";
      $tipo = "VV";
