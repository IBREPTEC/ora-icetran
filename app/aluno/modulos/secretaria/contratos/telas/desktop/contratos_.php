        ...
        <div class="row-fluid">
            <div class="span12 abox box-item extra-align">
                ...
                foreach($matriculas as $matricula) {
                    ...
                    $contratosGerados = $matriculaObj->RetornarContratosGerados();
                    foreach ($contratosGerados as $key => $value) {
                        array_push($contratos,$contratosGerados[$key]);
                    }
                    ?>
                    <div class="row-fluid">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="21%">
                                                            ...
                                                            if ($contrato['arquivo_servidor']) {
                                                                ...
                                                                ?>
                                                                <a href="/<?= $url[0]; ?>/<?= $url[1]; ?>/<?= $url[2]; ?>/<?= $contrato['idmatricula']; ?>/<?= $contrato['idmatricula_contrato']; ?>/contrato" target="_blank"><div class="btn btn-azul btn-mob"><?= $idioma["baixar"]; ?></div></a>
                                                                <?php
                                                            }
