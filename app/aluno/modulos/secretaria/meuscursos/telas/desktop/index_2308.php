    ...
    <div class="box-bg">
        ...
        foreach($matriculas as $matricula) {
            ...
            foreach ($contador as $cont) {
                $quantidade += count($cont['idmatricula']);
            }
                                            ...
                                            foreach ($retornaConteudo as $conteudo){
                                                ...
                                                foreach ($rotasDeAprendizagens as $ind => $rotaDeAprendizagem) {
                                                    ...
                                                    if ($conteudo['objeto']['idconteudo'] == $rotaDeAprendizagem['idconteudo']) {
                                                        $estouAqui['idconteudo'] = $rotaDeAprendizagem['idconteudo'] + 1;
                                                        $estouAqui= $rotaDeAprendizagem;
                                                        $dadosDisciplina = $matriculaObj->retornarObjeto($estouAqui);
                                                        $rota = $rotaDeAprendizagem['ordem'];
                                                    }
                                                ...
                                                if ($conteudo['objeto'] != "Falta Reconhecimento Facil") { ?>
                                                <a href="/<?= $url[0] ?>/academico/curso/<?= $matricula["idmatricula"]; ?>/<?=$conteudo['objeto']['idava'];?>/rota/<?=$rota?>#conteudo"><div class="alert alert-info text-center"><?= $nomeDisciplina ;?></div> </a>
                                        <?php } } ?>
