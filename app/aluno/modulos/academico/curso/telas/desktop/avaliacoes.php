...
<!-- Topo curso -->
<?php 
	incluirLib("topo_curso", $config, $informacoesTopoCurso); 
                    ...
                    <div class="abox extra-align">
                        ...
                        <div class="row-fluid">
                            <div class="span12 center-align" style="overflow-x: auto;">
                                            ...
                                            <td>
                                                ...
                                                if(
                                                    ...
                                                    <?php if( $ava['contabilizar_datas'] == 'S' ){ ?>
                                                        ...
                                                        <?php }else{ ?>
                                                            <a href="javascript:alert('<?php echo $idioma["js_carga_incompleta"], $horario_liberado; ?>');">
								...
								<br>
								<div class="row-fluid">
									<span style="font-weight: bold;" class="center-align">Se você já realizou a sua avaliação com sucesso, <a href="/<?= $url[0] ?>/academico/curso/<?= $matricula['idmatricula']; ?>">clique aqui</a> para retornar ao "ambiente de estudos"</span><br>
								</div>
								<?php 
									if ($curso['idcurso'] == 118) {
										echo "<a href='/$url[0]/$url[1]/$url[2]/$url[3]/$url[4]/simulado'>
												<img src='../../../../../../assets/aluno/img/simuladao.jpg' alt='Simuladao' 													style='margin-top: 10px;'>
											</a>";
									}
								?>
