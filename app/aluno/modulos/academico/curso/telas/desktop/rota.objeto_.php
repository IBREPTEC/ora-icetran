                            ...
                            <div class="nav-breadcrumb-item last-nav">
                                ...
                                <?php
                                 // echo "valor Ava " . $ava['idava'] . '<br />';
                                   ...
                                   $proximo = $ava['idava'];
                                     foreach ($idAvas as $ind => $idAva) {
                                         if ($proximo == $idAva && $ind < count($idAvas)) {
...
<!--<?php echo " DATA INI: ".$dataIni; echo " DATA HJ: ".$dataHoj; echo " BOOL CARGA: ".$cargaCompleta;  ?>-->
<!--<?php echo "BOOL_CARGA: ".$cargaCompleta; echo " ID OBJ: ".$objeto['idobjeto']; echo " ULT OBJ: ".$ultimoConteudoRota; echo "STATUS CONTA: ".$ava['contabilizar_datas']; ?>-->
</body>
</html>