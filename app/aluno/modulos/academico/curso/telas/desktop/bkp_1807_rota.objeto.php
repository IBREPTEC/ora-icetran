...
<div class="content" style="position: relative;">
    <div class="row container-fixed">
		...
		<div class="box-side min-side-box">
            <p>
                <a class="btn btn-primary" data-toggle="collapse" href="#boxAnotacoes" role="button" aria-expanded="false" aria-controls="boxAnotacoes" style="width: 91.3%;">Fazer Anotação</a>
            </p>
        </div>  			
