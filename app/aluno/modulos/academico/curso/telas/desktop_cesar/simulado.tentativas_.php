                ...
                <div class="span12">                
                    <div class="abox extra-align">
                        <div class="row-fluid m-box">
                            <div class="span3">
                                <div class="imagem-item"><img src="/api/get/imagens/avas_avaliacoes_imagem_exibicao/249/138/<?php echo $simulado["imagem_exibicao_servidor"]; ?>" alt="Avaliação" /></div>
                            </div>
                            <div class="span9">
                                    ...
                                    <tbody class="b-table">
                                        <?php foreach($tentativas as $simulado) { ?>
                                            <tr>
                                                ...
                                                <td><a href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/<?php echo $url[5]; ?>/<?php echo $url[6]; ?>/<?php echo $url[7]; ?>/<?php echo $simulado['idmatricula_simulado']; ?>/visualizar"><div class="btn btn-azul btn-mob"><?php echo $idioma["visualizar_prova"]; ?></div></a></td>
                                            </tr>
                                        <?php } ?>        
                                    </tbody> 
                                </table>
