<div id="side-menu" class="menu-align-fixed no-mobile">
    <ul>
        ...
        <?php }
		if(in_array('videoteca', $ava['modulos'])){ ?>  
			<li class="style-menu-fixed">
				<a class="m-carme" href="/<?php echo $url[0]; ?>/<?php echo $url[1]; ?>/<?php echo $url[2]; ?>/<?php echo $url[3]; ?>/<?php echo $url[4]; ?>/videoteca">
					<i class="icon-youtube-play"></i>
					<span class="side-menu-item"><?php echo $idioma['videoteca']; ?></span>
				</a>
			</li>
		<?php }
        if(in_array('anotacoes', $ava['modulos'])){ ?>  
            <li class="style-menu-fixed">
