...
<div class="content">
    <div class="row-fluid">
        <div class="span6 tile-align">
            <p class="user-log no-mobile"><?php echo sprintf($idioma['ultimo_cesso'], diferencaDias($informacoes['ultimo_acesso'])); ?></p>
        </div>
        <div class="span6 extra-progress tile-align out-bar">
            <p id="porcentagem" class="p-bar" style="position: relative;left: 90px;"><?php echo sprintf($idioma['andamento_curso'], number_format($informacoes['porcentagem'],2,',','.')); ?></p>
            <div class="progress progress-striped active" style="width: 56%;left: 100px;position: relative">
                <?php
                $porcentagem_ava = 100;
