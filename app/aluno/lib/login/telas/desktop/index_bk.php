...
<div class="login-box">
        ...
        <div class="row-fluid login">
            <div class="align-login">
                <div class="span12 title-login">
                    <img src="/assets/img/ibreptran_logo_pequena.png" alt="Logo" />
    ...
    <div class='row-fluid-adaptado'>
        <div class="pull-right">
            <!-- <img src="/assets/aluno/img/imagem_curso.png" width="110" height="35" alt="Curso Reciclagem de Condutores" />   
            <a href="http://ibrep.com.br/" target="_new"><img src="/assets/aluno/img/logo_ibrep_branco.png" width="95" height="25" alt="Ibrep"/></a> -->
        </div>
    </div>
  </div>
</div>
