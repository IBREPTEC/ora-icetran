...
?>
<!-- Topo -->
<?php if(array_key_exists('gestor', $informacoes) ||
...
<div class="top-user">
    <div class="content">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo $informacoes['link_pagina_anterior']; ?>"style="text-decoration: underline;text-transform: uppercase" >
                    <?php echo $idioma[$informacoes['pagina_anterior']]; ?>
                </a> <span class="divider">/</span>
            </li>

            <li>
                <a href="/aluno/academico/curso/<?php echo $informacoes['matricula']['idmatricula']; ?>" style="text-decoration: underline;text-transform: uppercase;">
                    <?php echo $informacoes['curso_nome']; ?>

              </a>
            </li>
           <?php if($informacoes['modulo']!=''){?>
               &nbsp; <span class="divider">/</span>&nbsp;

               <li>
                <a href="/aluno/academico/curso/<?php echo $informacoes['matricula']['idmatricula']; ?>/<?php echo $informacoes['ava']; ?>" style="text-decoration: underline;">
                    <?php echo $informacoes['modulo']; ?>
                </a>
            </li>
            <?php }?>
            <?php if($informacoes['pagina']!=''){?>
                &nbsp; <span class="divider">/</span>&nbsp;

                <li class="active">
                <?php
                echo $informacoes['pagina'];
                ?>
            </li>
            <?php }?>
        </ul>
