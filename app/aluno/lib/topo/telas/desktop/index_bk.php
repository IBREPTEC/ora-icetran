...
?>
<!-- Topo -->
<?php if($informacoes['pessoa']['gestor'] ||
        $informacoes['gestor'] ||
        $informacoes['pessoa']['professor'] ||
...
<div class="content">
    <div class="top">
        <a href="/<?= $url[0]; ?>" class="logo"><img  src="<?= (!empty($informacoes['escola']['avatar_servidor'])) ? "/api/get/imagens/escolas_avatar/x/40/".$informacoes['escola']["avatar_servidor"] : "/assets/aluno_novo/img/ibreptra_marca.png"; ?>" alt="Marca" /></a>
        <div class="content">
